(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();class c{constructor({text:t="",reading:e=""}={}){this.text=t,this.reading=e}format(){return this.text+(this.reading?"|"+this.reading:"")}static parse(t){const e=t.split("|").map(s=>s.trim());return new c({text:e[0],reading:e[1]||""})}}class a{constructor({id:t,updatedAt:e,title:s="",questions:i=[],lang:o="",voiceURI:l="",pitch:d="",rate:m="",volume:v=""}={}){this.id=t,this.updatedAt=e,this.title=s,this.questions=i.map(f=>new c(f)),this.lang=o,this.voiceURI=l,this.pitch=d,this.rate=m,this.volume=v}static parse(t){const e={questions:[]};for(const s of t.split(`
`).map(i=>i.trim()))s&&(s[0]==="{"?Object.assign(e,JSON.parse(s)):e.questions.push(c.parse(s)));return new a(e)}}class S{constructor(t){this.app=t,this.el=this.app.parse(`
...
`))||"",this.voicesMap=new Map;for(const s of(await this.app.getVoices()).sort((i,o)=>i.lang.localeCompare(o.lang))){const i=h(s.lang);let o=this.voicesMap.get(i);o||(o=[],this.voicesMap.set(i,o)),o.push(s)}const e=new Intl.DisplayNames([],{type:"language"});return this.langSelect.replaceChildren(...["",...this.voicesMap.keys()].map(s=>{let i;if(s){let o;try{o=e.of(s)}catch{o=s}i="["+s+"] "+o}else i="";return this.app.newOption(i,s)})),r(this.langSelect,h(t==null?void 0:t.lang)),this.updateVoiceSelect(),r(this.voiceSelect,t==null?void 0:t.voiceURI),r(this.pitchSelect,t==null?void 0:t.pitch,"1.0"),r(this.rateSelect,t==null?void 0:t.rate,"1.0"),r(this.volumeSelect,t==null?void 0:t.volume,"1.0"),this.app.root.appendChild(this.el),new Promise(s=>{this.resolveFunc=s})}updateVoiceSelect(){this.voiceSelect.replaceChildren(...[{name:"",localService:!0,voiceURI:""},...this.voicesMap.get(this.langSelect.value)||[]].map(t=>this.app.newOption(t.name+(t.localService?"":" (Remote)"),t.voiceURI)))}close(t){this.app.root.removeChild(this.el),this.resolveFunc(t)}}function h(n=""){if(n.includes("_")){const t=n.split(/[^0-9a-zA-Z]+/);t.length>2&&([t[1],t[2]]=[t[2],t[1]]),n=t.join("-")}return n}function r(n,t,e=""){(n.value=t)||(n.value=e)}class w{constructor(t){this.app=t,this.el=this.app.parse(`
    ...
    `),this.el.querySelector(".TitleOutput").textContent=this.app.title+" "+this.app.version,this.bookTable=this.el.querySelector(".BookTable"),this.el.querySelector(".NewButton").onclick=async()=>{await new u(this.app).show()&&this.updateBookTable()}}show(){this.updateBookTable(),this.app.root.appendChild(this.el)}updateBookTable(){const t=[];for(const e of this.app.findBooks()){const s=this.app.parse(`
      ...
      `),i=s.querySelector(".BookOutput");i.textContent="▶️ "+e.title,i.onclick=()=>{new p(this.app).show(e)},s.querySelector(".EditButton").onclick=async()=>{await new u(this.app).show(e)&&this.updateBookTable()},s.querySelector(".DeleteButton").onclick=async()=>{await this.app.confirm(`Delete "${e.title}" ?`)&&(this.app.deleteBook(e.id),this.updateBookTable())},t.push(s)}this.bookTable.replaceChildren(...t)}}class C{constructor(t){this.app=t,this.el=this.app.parse('<aside class="SplashView Center"></aside>')}show(t,e){return this.el.replaceChildren(t),this.app.root.appendChild(this.el),new Promise(s=>{setTimeout(()=>{this.app.root.removeChild(this.el),s()},e)})}}class O{constructor(t){this.name="ttslistening",this.id=t||this.name,this.bookIdKey=this.id+"/bookId",this.booksPrefix=this.id+"/books/",this.title=document.title,this.version="0.1.0"}start(){if(this.root=document.getElementById(this.id)||document.body,this.root.classList.add(this.name),!localStorage.getItem(this.bookIdKey))for(const t of[`{"title":"Fruits"}
🍏
🍎
🍐
🍊
